...
class Main {
  ...
  static final short crusading = 0;

  static final short civilly = 0;
...
class Hookworm<E extends Demising<Float, ? extends Number>>  {
  public Hookworm() {
...
class Thwacks<S, Y, R extends Y>  {
  public R funicular;

  public Thwacks(R funicular) {
    
    this.funicular = (R) null;
  }
