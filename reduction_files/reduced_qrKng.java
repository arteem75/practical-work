...
abstract class Wot {
   ? super Number, ? extends Number> frill(Function3<? super Byte, ? super Boolean, ? super Number, ? extends Number> erect) ;
}
...
interface Template<O extends Object> {
  r pomposity(Byte months, Boolean eschews, Number relying) {
