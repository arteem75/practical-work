...
class Main {
  ...
  static Bedlams stalker = (Bedlams) null;
  ...
  static public final Windsurfs<Polaris, Polaris, ? super Float> euclid(float maitreya, String thighbone) {
    ...
    Polaris ecology = new Polaris("");
    ;
    return ((pettifog) ?
      new Windsurfs<Polaris, Polaris, Float>((Bedlams) null, (Polaris) null) : 
...
abstract class Crooks {
  ...
  public Crooks(Function2<Character, ? super Boolean, ? extends Integer> premieres) {
    this.premieres = (Function2<Character, ? super Boolean, ? extends Integer>) null;
  }
}
...
final class Unsays  {
  ...
  public Unsays(Spumone<Integer> ignominy,long abreast) {
    ...
    this.ignominy = (Spumone<Integer>) null;
    this.abreast = 0L;
  }
