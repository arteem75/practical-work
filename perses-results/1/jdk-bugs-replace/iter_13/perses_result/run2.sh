...
expected_error="error: type argument ? extends Forceful<Snipes<Long,Long,Double>,Avicenna<? super Snipes<Long,Long,Double>>,Snipes<Long,Long,Double>> is not within bounds of type-variable Y"
expected_count=1
