...
class Main {
  static public final Function3<? super Number, Short, Integer, String> partied(Short slow) {
    ...
    return ((overgrew) ?
      ((false) ?
        remission : 
         lubricate::timidly) : 
       (Function3<? super Number, Short, Integer, String>) null);
    
  }

  static public final Long wantons() {
    final Long thudding = 0L;
    return 0L;
  ...
  static final Abusers gino = (Abusers) null;

  static Abusers flatware = (Abusers) null;
  ...
  static final short travelled = 0;
...
final class Senseless  {
  ...
  public Function2<Long, Boolean, Character> slugging() {
    ...
    return (Function2<Long, Boolean, Character>) null;
...
class Lankiness<Z>  {
  ...
  public Function2<Long, Boolean, Character> slugging() {
    ...
    final Function2<Long, Boolean, Character> lathes = (Function2<Long, Boolean, Character>) null;
