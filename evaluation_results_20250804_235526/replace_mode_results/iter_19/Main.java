...
final class Stupefies<S, Q extends Long, G extends Q>  {
  public Integer red;
...
final class Template  {
  ...
  public <F_G> Mild undaunted(F_G locavore) {
    ...
    final Shields stamped = new Shields(-57.277, (Character) null);
    stamped.windsurfs =  'r';
...
abstract class Shellfish  {
  ...
  public void calvinist(Double skivvy, Function3<Float, ? super Double, Float, ? extends Short> sprites) {
    ...
    naivest.apply(new Clouts<Integer, Object>((Shields) null),  'L');
    Object x_1 = (Stupefies<Integer, Long, Long>) null;
